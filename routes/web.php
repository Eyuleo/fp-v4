...
$router->post(
    "/student/profile/delete-file",
    "ProfileController@deletePortfolioFile",
    [new AuthMiddleware(), new RoleMiddleware("student"), new CsrfMiddleware()],
);

// Delete profile picture (student only)
$router->post(
    "/student/profile/delete-picture",
...
$router->get(
    "/student/profile/connect-stripe",
    "ProfileController@connectStripe",
    [new AuthMiddleware(), new RoleMiddleware("student")],
);

// Stripe Connect return (no auth middleware - handles session internally)
$router->get(
    "/student/profile/connect-stripe/return",
    "ProfileController@connectStripeReturn",
);
...
$router->get(
    "/student/withdrawals/stripe-dashboard",
    "WithdrawalController@stripeDashboard",
    [new AuthMiddleware(), new RoleMiddleware("student")],
);
