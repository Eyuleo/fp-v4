<div class="max-w-7xl mx-auto">
        ...
        <?php if (empty($orders)): ?>
            <div class="bg-white rounded-lg shadow-md p-12 text-center">
                ...
                <div class="mt-6">
                    <a href="/student/services" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700">
                        Manage Services
                    </a>
                </div>
            </div>
                        ...
                        <div class="flex items-start justify-between">
                            <div class="flex-1">
                                ...
                                <div class="flex items-center space-x-4 text-sm text-gray-600">
                                    <span>Client:                                                                                                                                                                                                                                                                                                                                                        <?php echo e($order['client_name'] ?? explode('@', $order['client_email'] ?? '')[0]) ?></span>
                                    <span>•</span>
