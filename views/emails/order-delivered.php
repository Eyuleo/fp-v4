...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Good news! Your order has been delivered by                                                           <?php echo e($student_name) ?>.</p>
            ...
            <div class="order-details">
                ...
                <div class="detail-row">
                    <span class="detail-label">Delivered:</span>                                                                 <?php echo e($delivered_at) ?>
                </div>
            </div>

            <p><strong>Delivery Message:</strong></p>
            <p style="background-color: white; padding: 15px; border-radius: 5px;"><?php echo nl2br(e($delivery_message)) ?></p>

            <p style="text-align: center;">
                <a href="<?php echo e($order_url) ?>" class="button">Review Delivery</a>
            </p>

            <p>Please review the delivered work. You can accept it, or request revisions if needed.</p>
        </div>
        <div class="footer">
