        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-2"><?php echo safe_number_format($analytics['total_orders']) ?></p>
                    <p class="text-xs text-gray-500 mt-1"><?php echo safe_number_format($analytics['completed_orders']) ?> completed</p>
                </div>
