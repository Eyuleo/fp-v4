...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            <div class="flex items-center">
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-900"><?php echo safe_number_format($totalAllReviews) ?></p>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            <div class="flex items-center">
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-900"><?php echo safe_number_format($totalVisibleReviews) ?></p>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            <div class="flex items-center">
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-900"><?php echo safe_number_format($totalFlaggedReviews) ?></p>
            ...
            <nav class="flex -mb-px">
                <a href="?filter="
                   class="px-6 py-4 text-sm font-medium border-b-2                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   <?php echo $filter === null ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' ?>">
                    All Reviews (<?php echo safe_number_format($totalAllReviews) ?>)
                </a>
                <a href="?filter=visible"
                   class="px-6 py-4 text-sm font-medium border-b-2                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   <?php echo $filter === 'visible' ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' ?>">
                    Visible (<?php echo safe_number_format($totalVisibleReviews) ?>)
                </a>
                <a href="?filter=flagged"
                   class="px-6 py-4 text-sm font-medium border-b-2                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   <?php echo $filter === 'flagged' ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' ?>">
                    Flagged (<?php echo safe_number_format($totalFlaggedReviews) ?>)
                </a>
            </nav>
        </div>
    </div>
    ...
    <div class="mb-4">
        <p class="text-sm text-gray-600">
            Showing                                                                                                                                                                            <?php echo count($reviews) ?> of<?php echo safe_number_format($totalReviews) ?> reviews
        </p>
    </div>
