<?php
    ...
    $title = 'Request Revision - Order #' . e($order['id']) . ' - Student Skills Marketplace';
...
<div class="max-w-3xl mx-auto">
    <!-- Header -->
    <div class="mb-6">
        <a href="/orders/<?php echo e($order['id']) ?>" class="text-blue-600 hover:text-blue-800 mb-4 inline-block">
            ← Back to Order
        </a>
        <h1 class="text-3xl font-bold text-gray-900">Request Revision</h1>
        <p class="text-gray-600 mt-2">Order #<?php echo e($order['id']) ?> - <?php echo e($order['service_title']) ?></p>
    </div>
        ...
        <div class="flex items-start">
            ...
            <div>
                ...
                <p class="text-sm text-blue-800">
                    You have used <?php echo e($order['revision_count']) ?> of <?php echo e($order['max_revisions']) ?> available revisions.
                        ...
                        <li>
                            <a href="<?php echo e($signedUrl) ?>"
                               ...
                               download>
                                ...
                                <span class="text-gray-500 text-sm ml-2">(<?php echo safe_number_format(($file['size'] ?? 0) / 1024, 2) ?> KB)</span>
                            </a>
                        </li>
                    <?php endforeach; ?>
                </ul>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <form action="/orders/<?php echo e($order['id']) ?>/request-revision" method="POST" data-loading>
