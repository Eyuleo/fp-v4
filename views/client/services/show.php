    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-yellow-700">
                                This service is currently unavailable/deactivated. You can view the details, but new orders cannot be placed.
                            </p>
                        </div>
                    </div>
                </div>
                                        ...
                                        <a href="<?php echo e($file['signed_url']) ?>"
                                           ...
                                           class="flex items-center justify-between p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                                            <div class="flex items-center space-x-3">
                                                ...
                                                <?php endif; ?>
                                                <div>
                                                    <span class="text-sm text-gray-900 font-medium"><?php echo e($originalName) ?></span>
                                                    <span class="text-xs text-gray-500 block"><?php echo strtoupper($extension) ?> File</span>
                                                </div>
                                            </div>
                                            <span class="text-blue-600 hover:text-blue-700 text-sm font-medium">Download</span>
                                        </a>
                                    <?php endforeach; ?>
                                </div>
                            </div>
        ...
        <div class="lg:col-span-1">
            <div class="bg-white rounded-lg shadow-sm p-6 sticky top-8">
                ...
                <!-- Order Button -->
                <?php if ($service['status'] !== 'active'): ?>
                    <button disabled class="block w-full bg-gray-300 text-gray-500 text-center px-6 py-3 rounded-lg font-medium cursor-not-allowed">
                        Service Unavailable
                    </button>
